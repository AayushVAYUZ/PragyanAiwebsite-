    ...
    >
      ...
      <div className="relative z-10 flex min-h-[calc(var(--svh)*100)] flex-col justify-between px-[var(--gutter-x)] pt-24 pb-20">
        <div className="max-w-3xl pt-4 lg:pt-8">
          <p
            data-journey-copy
            className="mb-6 inline-flex items-center gap-2.5 rounded-full border border-white/10 bg-[#070B18]/60 px-3 py-1"
          >
            <span aria-hidden="true" className="h-2 w-2 animate-pulse rounded-full bg-[var(--neon-cyan)]" />
            <span className="font-[family-name:var(--font-mono)] text-[10px] font-medium tracking-[0.22em] text-[var(--text-soft)]/90 uppercase">
              06 — Our Journey
            </span>
          </p>
          <h2
      ...
      <SectionContinuum index="06" title="Our Journey" next={{ href: "#prism", label: "Proceed to 07 — PRISM" }} />
    </section>
  );
}
