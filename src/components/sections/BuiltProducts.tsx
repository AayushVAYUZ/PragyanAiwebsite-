        ...
        <div className="mx-auto w-full max-w-7xl">
          <div className="mb-14 grid grid-cols-1 items-end gap-6 lg:mb-16 lg:grid-cols-12 lg:gap-8">
            <div className="lg:col-span-7">
              <p data-built-copy className="mb-6 flex items-center gap-2.5">
                <span aria-hidden="true" className="h-2 w-2 rounded-full bg-[var(--neon-cyan)] shadow-[0_0_10px_#26C6FF]" />
                <span className="font-[family-name:var(--font-mono)] text-[11px] tracking-[0.25em] text-[#A0AFDC]/80 uppercase">
                  10 — What We&apos;ve Built
                </span>
              </p>
              <h2
