    ...
    >
      ...
      <div className="footer-content relative z-10 px-[var(--gutter-x)] pt-24 pb-10">
        <div className="mx-auto w-full max-w-[1152px]">
          <p data-footer-copy className="mb-12 flex items-center gap-3">
            <span aria-hidden="true" className="h-1.5 w-1.5 rounded-full bg-[var(--neon-cyan)] shadow-[0_0_8px_#26C6FF]" />
            <span className="font-[family-name:var(--font-mono)] text-xs tracking-[0.25em] text-[#A2A8BC] uppercase">15 — Footer</span>
          </p>
      ...
      {/* Legal row: closes the page in place of a continuum bar */}
      <div className="footer-legal footer-content relative z-10 w-full px-[var(--gutter-x)] py-5">
        <div className="mx-auto flex w-full max-w-[1152px] flex-col items-center justify-between gap-4 md:flex-row">
          <p className="order-2 text-[11px] text-slate-500 md:order-1">© 2026 Pragyan AI. All rights reserved.</p>

          <div className="order-1 flex items-center gap-6 text-xs font-light md:order-2">
          ...
          <p className="order-3 flex items-center gap-3 font-[family-name:var(--font-mono)] text-[11px] tracking-wider text-slate-400">
            <span className="uppercase">15 / 15 | Footer</span>
            <span className="inline-flex items-center gap-1.5 rounded-full border border-slate-700/50 bg-slate-900/80 px-2.5 py-0.5 text-[10px] text-[var(--neon-cyan)] uppercase">
              <span aria-hidden="true" className="footer-status-dot h-1.5 w-1.5 rounded-full bg-[var(--neon-cyan)]" />
              Journey Complete
            </span>
          </p>
        </div>
